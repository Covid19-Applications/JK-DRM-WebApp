            ...
            <div class="major-caousel js-carousel-1 owl-carousel">
              ...
              <div>
                <div class="media d-block media-custom text-center"><br>
                  <a href="covid_ind/Tracker - Odisha/index.php"><img src="img/kash/map.jpg" alt="Image Placeholder" class="img-fluid"></a>
                 
                  <div class="media-body" style="background-color: #121212">
                    <h3 class="mt-0 text-white">JAMMU & KASHMIR ANALYSIS</h3>
        ...
        <div class="row mb-5">
          <div class="col-md-4 mb-5">
            ...
            <ul class="list-unstyled footer-link d-flex footer-social">
              <li><a href="#" class="p-2" style="color: darkblue"><span class="fa fa-twitter"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkblue"><span class="fa fa-facebook"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkblue"><span class="fa fa-linkedin"></span></a></li>
              <li><a href="#" class="p-2"style="color: darkblue"><span class="fa fa-instagram"></span></a></li>
            </ul>
          ...
          <div class="col-md-5 mb-5">
            ...
            <div>
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block">
                  <span class="d-block text-grey"style="color: darkblue">Address:</span>
                  <span style="color: darkblue">34 Street Name, J&K, India</span></li>
                <li class="d-block" ><span class="d-block text-grey"style="color: darkblue" >Phone:</span><span>+1 242 4942 290</span></li>
                <li class="d-block"><span class="d-block text-grey"style="color: darkblue">Email:</span><span>info@ej&k.com</span></li>
              </ul>
            </div>
          </div>
          <div class="col-md-3 mb-5">
            ...
            <ul class="list-unstyled footer-link">
              <li><a href="#"style="color: darkblue">About</a></li>
              <li><a href="#"style="color: darkblue">Terms of Use</a></li>
              <li><a href="#"style="color: darkblue">Disclaimers</a></li>
              <li><a href="#"style="color: darkblue">Contact</a></li>
            </ul>
          </div>
          <div class="col-md-3">
