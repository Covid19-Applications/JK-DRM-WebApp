...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN JAMMU & KASHMIR</h1>
  <br><br>
  <CENTER>
  <div ><a href="https://www.jknhm.com/covidfacilities.php">
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='jammu & kashmir'";
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    var newArray = covid_data.records.filter(function (el) {
      ...
      return el.state_name === 'Jammu and Kashmir';
